...
text \<open>Eine Position ist eine #Philo(Zuweisung) #Info(Interpretation) Literalen \<close>
...
#Info Diese Anforderung macht die mods Relation linkstotal.\<close>
...
#Info Diese Anforderung macht die mods Relation rechtseindeutig.\<close>
...
#Info Wenn die Position dem Argument erfüllt, dann modelliert die Interpretation P das Argument (P \<Turnstile> ps \<longrightarrow> c)\<close>
